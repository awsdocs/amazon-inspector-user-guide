# Troubleshooting Amazon Inspector identity and access<a name="security_iam_troubleshoot"></a>
...
+ [I'm an administrator and want to allow others to access Amazon Inspector](#security_iam_troubleshoot-admin-delegate)
...
## I am not authorized to perform an action in Amazon Inspector<a name="security_iam_troubleshoot-no-permissions"></a>
...
```
User: arn:aws:iam::123456789012:user/mateojackson is not authorized to perform: inspector:CreateAssessmentTemplate
```
...
## I'm an administrator and want to allow others to access Amazon Inspector<a name="security_iam_troubleshoot-admin-delegate"></a>
...
## I want to allow people outside of my AWS account to access my Amazon Inspector resources<a name="security_iam_troubleshoot-cross-account-access"></a>
